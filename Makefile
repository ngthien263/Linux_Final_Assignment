...
all: make_dir create_obj 
	$(CC) $(CFLAGS) $(OBJ_DIR)/linkedList.o $(OBJ_DIR)/socket.o $(OBJ_DIR)/sensor_reader.o $(OBJ_DIR)/sensor_gateway.o $(OBJ_DIR)/thread_handle.o -o $(BIN_DIR)/sensor_gateway -lpthread -lsqlite3
	$(CC) $(CFLAGS) $(OBJ_DIR)/linkedList.o $(OBJ_DIR)/socket.o $(OBJ_DIR)/sensor_sender.o $(OBJ_DIR)/sensor_node.o -o $(BIN_DIR)/sensor_node -lpthread -lsqlite3
